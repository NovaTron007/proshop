...
// Assign in reducer in store, to access date.
// Data flow: dispatch action->action fetches data into payload->reducer->reducer receives action->reducer assigned in store (create in this order: consts, reducer, store, action )
...
// My orders:state empty orders array to prepare to receive order
